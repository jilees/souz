...
interface ToolsSettingsStore {
    fun loadToolsSettings(key: String): ToolsSettingsState?
    fun saveToolsSettings(key: String, state: ToolsSettingsState)
}
...
class ToolsSettings(
    private val store: ToolsSettingsStore,
    ...
    fun load(
        ...
        val storedState: ToolsSettingsState? = store.loadToolsSettings(TOOLS_SETTINGS_KEY)
    ...
    fun isCategoryAllowed(category: ToolCategory): Boolean {
        ...
        val storedState: ToolsSettingsState = store.loadToolsSettings(TOOLS_SETTINGS_KEY) ?: return true
    ...
    fun save(state: ToolsSettingsState) {
        ...
        store.saveToolsSettings(TOOLS_SETTINGS_KEY, normalizedState)
    }
