...
class ToolRunSkillCommand(
    ...
    override val description: String = buildString {
        ...
        append("On a Salute device sandbox, workingDirectory/environment are not delivered to the device — use scriptPath so the backend resolves supporting files server-side instead of inlining them. ")
